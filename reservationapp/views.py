...
from reservationapp.models import Flight, Passenger, Reservation
from reservationapp.serializers import FlightSerializer, PassengerSerializer, ReservationSerializer
